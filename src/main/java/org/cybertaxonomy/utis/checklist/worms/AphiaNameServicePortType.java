...
public interface AphiaNameServicePortType extends java.rmi.Remote {
    ...
    /**
     * <strong>Get the AphiaID for a given name</strong>
     * 		<br />Parameters:
     * 		<ul>
     ...
     * (BOLD) TaxID</li><li><u>dyntaxa</u>: Dyntaxa ID</li><li><u>eol</u>:
     * Encyclopedia of Life (EoL) page identifier</li><li><u>fishbase</u>:
     ...
     * for this taxon. See <a href='http://www.marinespecies.org/aphia.php?p=manual#topic6'
     ...
     * see <a href='http://www.marineregions.org/mrgid.php' target='_blank'>http://www.marineregions.org/mrgid.php</a></li><li>
     ...
     * IHO Sea Area or Nation, derived from the MarineRegions <a href='http://www.marineregions.org/gazetteer.php'
     ...
     * or 'inaccurate'. See <a href='http://www.marinespecies.org/aphia.php?p=manual#topic8b'
     ...
     * or 'unreviewed'. See <a href='http://www.marinespecies.org/aphia.php?p=manual#topic22'
     * target='_blank'>http://www.marinespecies.org/aphia.php?p=manual#topic22</a></li></ul>
     */
     ...
     * : Quality status of the record. Possible values: 'checked', 'trusted'
     * or 'unreviewed'. See <a href='http://www.marinespecies.org/aphia.php?p=manual#topic22'
     * target='_blank'>http://www.marinespecies.org/aphia.php?p=manual#topic22</a></li><li>
