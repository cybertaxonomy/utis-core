<?xml version="1.0" encoding="UTF-8" ?>
     ...
     <xsl:stylesheet version="1.0"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
       ...
       <xsl:template match="/">   
       <tnrResponse xmlns="http://bgbm.org/biovel/drf/tnr/msg" checklist="Catalogue Of Life" checklist_url="http://www.catalogueoflife.org/prototype/content/about" >
     ...
     <xsl:template match="result">
       ...
       <xsl:choose>
         <xsl:when test="name_status='accepted name'">           
           <acceptedName xmlns="http://bgbm.org/biovel/drf/tnr/msg" >
             <taxonName>
         ...
         <xsl:otherwise>
           <otherName xmlns="http://bgbm.org/biovel/drf/tnr/msg">
             <taxonName>
               <authorship><xsl:apply-templates select="author"/></authorship>
               <name>
                 <nameCanonical><xsl:apply-templates select="name"/></nameCanonical>
     ...
     <xsl:template match="synonym">
       ...
       <synonym xmlns="http://bgbm.org/biovel/drf/tnr/msg">
         <taxonName>
           <authorship><xsl:apply-templates select="author"/></authorship>
           <name>
             <nameCanonical><xsl:apply-templates select="name"/></nameCanonical>
