...
import org.cybertaxonomy.utis.refine.RefineClient;
import org.cybertaxonomy.utis.refine.RefineException;
...
public class RefineClientTest {
    ...
    @Test
    @Ignore // AK (06.01.2015) : can not fix this at the moment, test in error never fails, loops endlessly
